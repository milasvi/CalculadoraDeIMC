...
while True:
    altura = float(input('Qual sua altura? (Digite com ponto em vez de vírgula)'))
    ...
    if imc < 18.6:
        ...
        print('Seu IMC está normal, mas procure um(a) médico(a) para fazer um checkup mesmo assim.')
    elif imc > 25 or imc == 25 or imc < 29.9 or imc == 29.9:
        print('Seu IMC está sobrepeso, procure um(a) médico(a) para fazer um checkup!)')
    else:
        print('Seu IMC é obeso, procure um(a) médico(a) para fazer um checkup.')
